...
export default function CompleteAdminDashboard() {
    ...
    const [adminFeeAddresses, setAdminFeeAddresses] = useState([
    ...
    const [dexConnections, setDexConnections] = useState([
          ...
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie data={feeBreakdown} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={100} label>
                {feeBreakdown.map((_, index) => (<Cell key={`cell-${index}`} fill={COLORS[index % COLORS.length]}/>))}
              </Pie>
              <Tooltip contentStyle={{ backgroundColor: '#1F2937', border: 'none' }}/>
              <Legend />
            </PieChart>
    ...
    const renderBotManagement = () => (<div className="space-y-6">
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {recentBots.map((bot) => (<tr key={bot.id} className="border-b border-gray-700">
      ...
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {botTiers.map((tier) => (<div key={tier.id} className="bg-gray-700 rounded-lg p-4">
    ...
    const renderFeeManagement = () => (<div className="space-y-6">
      ...
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {adminFeeAddresses.map((addr) => (<tr key={addr.id} className="border-b border-gray-700">
      ...
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {feeConfigs.map((config) => (<tr key={config.id} className="border-b border-gray-700">
    ...
    const renderExternalConnections = () => (<div className="space-y-6">
      {/* CEX Connections */}
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {cexConnections.map((conn) => (<tr key={conn.id} className="border-b border-gray-700">
      ...
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {dexConnections.map((conn) => (<tr key={conn.id} className="border-b border-gray-700">
                  <td className="py-3 px-4 text-gray-300">{conn.userEmail}</td>
    ...
    const renderBlockchainManagement = () => (<div className="space-y-6">
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {blockchains.map((chain) => (<tr key={chain.id} className="border-b border-gray-700">
    ...
    const renderTokenListings = () => (<div className="space-y-6">
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {tokenListings.map((listing) => (<tr key={listing.id} className="border-b border-gray-700">
    ...
    const renderAPIManagement = () => (<div className="space-y-6">
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {apiKeys.map((key) => (<tr key={key.id} className="border-b border-gray-700">
    ...
    return (<div className="min-h-screen bg-gray-900 text-white">
      ...
      <nav className="bg-gray-800 border-b border-gray-700">
        ...
        ].map((tab) => (<button key={tab.id} onClick={() => setCurrentTab(tab.id)} className={`py-4 px-2 border-b-2 ${currentTab === tab.id
...
//# sourceMappingURL=CompleteAdminDashboard.jsx.map