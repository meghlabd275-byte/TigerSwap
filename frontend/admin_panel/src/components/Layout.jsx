...
import { AppBar, Toolbar, Typography, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, IconButton, Avatar, Menu, MenuItem, Divider, useTheme, Badge } from '@mui/material';
import { Dashboard, People, Pool, Hub, Receipt, ShowChart, SmartToy, AccountTree, HubOutlined, AttachMoney, Security, Analytics, Settings, Menu as MenuIcon, Notifications } from '@mui/icons-material';
...
const Layout = () => {
    ...
    const drawer = (<div>
      ...
      <Divider />
      <List>
        {menuItems.map((item) => (<ListItem button key={item.text} component="a" href={item.path} sx={{ '&:hover': { bgcolor: 'action.hover' } }}>
