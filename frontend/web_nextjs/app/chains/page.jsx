...
export default function ChainsPage() {
    ...
    return (<div style={{ background: bgPrimary, minHeight: '100vh', color: textPrimary }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: 24 }}>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 16 }}>
            {chains.filter(c => c.type === 'evm').map(chain => (<div key={chain.id} onClick={() => setSelectedChain(chain)} style={{
      ...
      {selectedChain && (<div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }} onClick={() => setSelectedChain(null)}>
