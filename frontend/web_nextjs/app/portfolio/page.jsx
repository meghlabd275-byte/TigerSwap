...
import { Box, Typography, Card, CardContent, Chip, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Tabs, Tab } from '@mui/material';
import { Wallet, ShowChart, TrendingUp, Pool } from '@mui/icons-material';
// ============================================================================
// Mock Data
// ============================================================================
const ASSETS = [
    ...
    return (<Box sx={{ minHeight: '100vh', bgcolor: '#0a0a14', p: 3 }}>
      <Box sx={{ maxWidth: 1400, mx: 'auto' }}>
        ...
        <Card sx={{ bgcolor: '#1a1a2e', borderRadius: 3, mb: 3 }}>
          <Tabs value={activeTab} onChange={(_, v) => setActiveTab(v)} sx={{ borderBottom: '1px solid #2a2a3e', '& .MuiTab-root': { color: '#9ca3af' }, '& .Mui-selected': { color: '#00d4aa' } }}>
            <Tab label="Assets"/>
            <Tab label="Positions"/>
            <Tab label="History"/>
          </Tabs>
          ...
          <CardContent sx={{ p: 3 }}>
            {activeTab === 0 && (<TableContainer>
                <Table>
                  ...
                  <TableBody>
                    {assets.map(asset => (<TableRow key={asset.symbol} sx={{ '&:hover': { bgcolor: '#2a2a3e' } }}>
                        <TableCell>
            ...
            {activeTab === 1 && (<TableContainer>
                <Table>
                  ...
                  <TableBody>
                    {positions.map((pos, i) => (<TableRow key={i} sx={{ '&:hover': { bgcolor: '#2a2a3e' } }}>
                        <TableCell>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            {activeTab === 2 && (<TableContainer>
                <Table>
                  ...
                  <TableBody>
                    {transactions.map(tx => (<TableRow key={tx.hash} sx={{ '&:hover': { bgcolor: '#2a2a3e' } }}>
                        <TableCell>
