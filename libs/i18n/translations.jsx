...
export function TranslationProvider({ children }) {
    ...
    return (<TranslationContext.Provider value={{ language, setLanguage, t, languages: LANGUAGES }}>
      {children}
...
export function LanguageSelector() {
    ...
    return (<select value={language} onChange={(e) => setLanguage(e.target.value)} style={{
            background: '#2a2a3e',
            color: 'white',
