...
import { StyleSheet, Text, View, TouchableOpacity, ScrollView, TextInput, Alert, SafeAreaView, StatusBar, } from 'react-native';
...
class WalletService {
    ...
    async importWallet(mnemonic, chain) {
    ...
    return (<SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.actions}>
          ...
          <TouchableOpacity style={styles.actionButton} onPress={() => navigation.navigate('Buy')}>
            <Text style={styles.actionIcon}>💳</Text>
        ...
        <View style={styles.section}>
          ...
          {tokens.map((token, index) => (<View key={index} style={styles.tokenItem}>
        ...
        <View style={styles.section}>
          ...
          {transactions.map((tx, index) => (<View key={index} style={styles.txItem}>
...
function SendScreen({ navigation }) {
    ...
    return (<SafeAreaView style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <TextInput style={styles.input} value={recipient} onChangeText={setRecipient} placeholder="0x..." placeholderTextColor="#999"/>

        <Text style={styles.label}>Amount</Text>
        <View style={styles.amountInput}>
          <TextInput style={[styles.input, { flex: 1 }]} value={amount} onChangeText={setAmount} placeholder="0.00" placeholderTextColor="#999" keyboardType="decimal-pad"/>
...
function SwapScreen({ navigation }) {
    ...
    return (<SafeAreaView style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <Text style={styles.label}>Amount</Text>
        <TextInput style={styles.input} value={amount} onChangeText={setAmount} placeholder="0.00" placeholderTextColor="#999" keyboardType="decimal-pad"/>
